...
import vn.ypp4.quanphan.service.mapper.row.ReactionCategoryRowMapper;
...
public class ReactionCategoryServiceImpl {
        ...
        if (categoryValue != null && !finalCategoryValue.equalsIgnoreCase(existingCategory.getCategoryValue())) {
            ...
            if (count != null && count > 0) {
                throw new IllegalStateException(
                        "Another reaction category with value '" + finalCategoryValue + "' already exists");
            }
        }
    ...
    public int deleteReactionCategory(int id) {
        ...
        if (usageCount != null && usageCount > 0) {
            throw new IllegalStateException(
                    "Cannot delete reaction category as it is being used by " + usageCount + " reaction(s)");
        }
