...
import vn.ypp4.quanphan.service.mapper.BillingPlanRowMapper;
...
public class BillingPlanServiceImpl {
    ...
    public int updateBillingPlan(int id, String planName, String billingPlanDescription, 
        ...
        String finalDescription = billingPlanDescription != null ? billingPlanDescription : existingPlan.getBillingPlanDescription();
