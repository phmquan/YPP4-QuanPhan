...
import vn.ypp4.quanphan.service.mapper.CustomFieldRowMapper;
...
public class CustomFieldServiceImpl {
    ...
    public int updateCustomField(int id, String title, Integer dataTypeId, Boolean isFrontCardShowed,
        ...
        boolean finalIsFrontCardShowed = isFrontCardShowed != null ? isFrontCardShowed : existingField.isFrontCardShowed();
