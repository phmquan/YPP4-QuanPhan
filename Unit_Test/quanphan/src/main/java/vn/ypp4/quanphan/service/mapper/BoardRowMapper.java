...
public class BoardRowMapper extends BaseRowMapper<Board> {
    ...
    protected Board mapRowInternal(ResultSet rs, int rowNum) throws SQLException {
        ...
        board.setCreatedAt(rs.getTimestamp("CreatedAt") != null ? rs.getTimestamp("CreatedAt").toInstant() : null);
        ...
        board.setUpdatedAt(rs.getTimestamp("UpdatedAt") != null ? rs.getTimestamp("UpdatedAt").toInstant() : null);
