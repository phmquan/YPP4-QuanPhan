...
import vn.ypp4.quanphan.service.mapper.PowerUpRowMapper;
...
public class PowerUpServiceImpl {
    ...
    public int updatePowerUp(int id, String powerUpName, String iconUrl, String backgroundUrl, 
        ...
        String finalPowerUpDescription = powerUpDescription != null ? powerUpDescription : existingPowerUp.getPowerUpDescription();
