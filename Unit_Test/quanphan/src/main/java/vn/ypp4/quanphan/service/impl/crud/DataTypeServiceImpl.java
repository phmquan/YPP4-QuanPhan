...
import vn.ypp4.quanphan.service.mapper.DataTypeRowMapper;
...
public class DataTypeServiceImpl {
    ...
    public int deleteDataType(int id) {
        ...
        if (usageCount != null && usageCount > 0) {
            throw new IllegalStateException("Cannot delete data type as it is being used by " + usageCount + " custom field(s)");
        }
