...
import vn.ypp4.quanphan.service.mapper.StickerCategoryRowMapper;
...
public class StickerCategoryServiceImpl {
    ...
    public int updateStickerCategory(int id, String categoryValue, String displayValue) {
        ...
        if (categoryValue != null && !finalCategoryValue.equalsIgnoreCase(existingCategory.getCategoryValue())) {
            ...
            if (count != null && count > 0) {
                throw new IllegalStateException("Another sticker category with value '" + finalCategoryValue + "' already exists");
            }
        }
    ...
    public int deleteStickerCategory(int id) {
        ...
        if (usageCount != null && usageCount > 0) {
            throw new IllegalStateException("Cannot delete sticker category as it contains " + usageCount + " sticker(s)");
        }
