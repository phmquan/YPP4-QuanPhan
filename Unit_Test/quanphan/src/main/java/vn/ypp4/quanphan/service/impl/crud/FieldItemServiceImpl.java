...
import vn.ypp4.quanphan.service.mapper.FieldItemRowMapper;
...
public class FieldItemServiceImpl {
    ...
    public int deleteFieldItem(int id) {
        ...
        if (usageCount != null && usageCount > 0) {
            throw new IllegalStateException("Cannot delete field item as it is being used by " + usageCount + " field value(s)");
        }
